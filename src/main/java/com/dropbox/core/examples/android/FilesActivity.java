...
public class FilesActivity extends DropboxActivity {
    ...
    public static Intent getIntent(Context context, String path, boolean CLEARSTACK) {
        Intent filesIntent = new Intent(context, FilesActivity.class);
        filesIntent.putExtra(FilesActivity.EXTRA_PATH, path);
        if(CLEARSTACK) filesIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
        return filesIntent;
    }
                ...
                new NavigationView.OnNavigationItemSelectedListener() {
                    ...
                    public boolean onNavigationItemSelected(MenuItem menuItem) {
                        ...
                        switch (menuItem.getItemId()) {
                            case R.id.nav_home:
                                Toast.makeText(FilesActivity.this, "Home selected", Toast.LENGTH_LONG).show();
                                break;
                            case R.id.nav_files:
                                finish();
                                startActivity(FilesActivity.getIntent(FilesActivity.this, "",true));
                                Toast.makeText(FilesActivity.this, "Files selected", Toast.LENGTH_LONG).show();
                                break;
                            case R.id.nav_notifications:
                                Toast.makeText(FilesActivity.this, "Notifications selected", Toast.LENGTH_LONG).show();
    ...
    protected void loadData() {
        ...
        mFilesAdapter = new FilesAdapter(PicassoClient.getPicasso(), new FilesAdapter.Callback() {
            ...
            public void onFolderClicked(FolderMetadata folder) {
                startActivity(FilesActivity.getIntent(FilesActivity.this, folder.getPathLower(),false));
            }
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.download_item:
                Toast.makeText(FilesActivity.this, "Download...", Toast.LENGTH_LONG).show();
                return true;
            case R.id.copy_item:
                Toast.makeText(FilesActivity.this, "Copy...", Toast.LENGTH_LONG).show();
                return true;
            case R.id.move_item:
                Toast.makeText(FilesActivity.this, "Move...", Toast.LENGTH_LONG).show();
                return true;
            case  R.id.delete_item:
                Toast.makeText(FilesActivity.this, "Delete...", Toast.LENGTH_LONG).show();
                return true;
            default:
